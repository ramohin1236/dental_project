...
export default function EditProfile() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Optimistically update cached profile so UI reflects immediately
            ...
            try {
                dispatch(
                    usersApi.util.updateQueryData('getMyProfile', undefined, (draft) => {
                        ...
                        // handle shapes: {data: {...}} or direct object
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="flex-1 px-4 py-3 border-2 border-[#136BFB] rounded-lg text-white placeholder-gray-400"
