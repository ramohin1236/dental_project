...
export default function Product() {
  ...
  return (
    <>
      ...
      <div className="absolute top-1/2 left-0 -z-10 pb-20">
      ...
      <div className="mx-auto container text-white">
        ...
        <div className="flex flex-col md:flex-row gap-4 sm:gap-5 md:gap-6 min-h-screen px-2 sm:px-4 md:px-0 pb-16 md:pb-24">
          {/* =============== Filter Sidebar =============== */}
          <div className="bg-gray-800 px-3 sm:px-4 rounded-lg w-full md:w-1/4 lg:w-1/5 xl:w-1/5 md:h-[90vh] h-auto mb-6 md:mb-0 overflow-y-auto no-scrollbar z-20 relative">
          ...
          <div className="w-full  flex flex-col">
            {viewProducts.length === 0 ? (
              <div className="w-full flex flex-col items-center justify-center text-center bg-[#1E1E1E]/40 rounded-lg p-10 md:p-14 border border-gray-800" aria-live="polite">
                <div className="mb-4">
